...
.reviews-luxe__glow{position:absolute;border-radius:50%;filter:blur(80px);opacity:.18;pointer-events:none;z-index:-3}.reviews-luxe__glow--a{width:34vw;height:34vw;left:-10vw;top:12%;background:#7a8a4c}.reviews-luxe__glow--b{width:28vw;height:28vw;right:-7vw;top:4%;background:#a28442}.reviews-luxe__grain{position:absolute;inset:0;opacity:.07;pointer-events:none;background-image:radial-gradient(circle at 20% 30%,#fff 0 1px,transparent 1.2px),radial-gradient(circle at 70% 80%,#fff 0 1px,transparent 1.2px);background-size:11px 11px,17px 17px;mix-blend-mode:soft-light}.reviews-luxe__inner{position:relative}.reviews-luxe__top{display:grid;grid-template-columns:1fr auto;gap:3rem;align-items:end;margin-bottom:3.8rem}.reviews-luxe__top h2{font-size:clamp(3rem,6.7vw,6.5rem);max-width:8ch;font-weight:500;line-height:.9;letter-spacing:-.045em;margin-top:.7rem}.reviews-luxe__top h2 em{font-style:italic;font-weight:400;color:var(--gold)}.reviews-luxe__kicker{margin-top:1.2rem;font-family:var(--mono);font-size:.72rem;letter-spacing:.28em;color:rgba(232,225,215,.5)}.reviews-luxe__aside{display:flex;flex-direction:column;align-items:flex-end;gap:1.25rem;padding-bottom:.3rem}.reviews-luxe__aside>p{font-family:var(--display);font-size:1rem;line-height:1.4;color:rgba(232,225,215,.78);text-align:left}.reviews-luxe__controls{display:flex;align-items:center;gap:.65rem;font-family:var(--mono);font-size:.68rem;letter-spacing:.14em;color:rgba(232,225,215,.72)}.reviews-luxe__controls>span{margin-right:.2rem}.reviews-luxe__arrow,.reviews-luxe__edge{appearance:none;border:1px solid rgba(201,178,127,.72);background:rgba(10,17,12,.38);color:var(--gold-bright);border-radius:999px;cursor:pointer;display:grid;place-items:center;transition:transform .3s var(--ease-out),background .3s var(--ease),border-color .3s var(--ease)}.reviews-luxe__arrow{width:42px;height:42px;font-size:1.3rem}.reviews-luxe__arrow:hover,.reviews-luxe__edge:hover{transform:translateY(-2px);background:rgba(201,178,127,.1);border-color:var(--gold-bright)}.reviews-luxe__stage{position:relative;min-height:500px;display:grid;align-items:end;isolation:isolate;overflow:visible}.reviews-luxe__stage:before{content:"";position:absolute;left:-12vw;right:-12vw;bottom:38px;height:78px;z-index:0;border-top:1px solid rgba(238,231,218,.38);background:linear-gradient(180deg,rgba(239,233,222,.96) 0%,rgba(206,198,185,.98) 100%),repeating-linear-gradient(116deg,transparent 0 90px,rgba(107,120,103,.17) 91px 93px,transparent 94px 175px),repeating-linear-gradient(64deg,transparent 0 135px,rgba(125,108,96,.14) 136px 138px,transparent 139px 240px);box-shadow:0 -14px 40px rgba(217,211,197,.08),0 10px 30px rgba(0,0,0,.4);transform:perspective(900px) rotateX(62deg);transform-origin:bottom center}.reviews-luxe__stage:after{content:"";position:absolute;left:-12vw;right:-12vw;bottom:0;height:48px;z-index:0;background:linear-gradient(180deg,#b9ae9e 0%,#786f63 42%,#4d463e 100%);border-top:1px solid rgba(255,255,255,.2);box-shadow:inset 0 1px 0 rgba(255,255,255,.14),0 18px 35px rgba(0,0,0,.55)}.reviews-luxe__track{position:relative;z-index:2;display:flex;align-items:flex-end;gap:28px;transition:transform .78s cubic-bezier(.16,1,.3,1);will-change:transform;padding:0 max(9vw,110px) 96px}.reviews-luxe__card{position:relative;flex:0 0 min(31vw,430px);min-height:340px;padding:2.25rem 2.1rem 2rem;border:1px solid rgba(201,178,127,.52);border-radius:24px;background:linear-gradient(145deg,rgba(48,56,42,.8),rgba(25,33,25,.86));box-shadow:0 30px 70px rgba(0,0,0,.28),0 18px 32px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.035);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);transform:scale(.9) rotateY(2deg);transform-origin:center bottom;opacity:.58;transition:transform .78s cubic-bezier(.16,1,.3,1),opacity .55s ease,box-shadow .55s ease}.reviews-luxe__card.is-active{transform:scale(1.06) rotateY(0);opacity:1;box-shadow:0 35px 90px rgba(0,0,0,.42),0 26px 34px rgba(0,0,0,.3),0 0 0 1px rgba(201,178,127,.11),inset 0 1px 0 rgba(255,255,255,.05)}.reviews-luxe__card:after{content:"";position:absolute;left:12%;right:12%;bottom:-16px;height:24px;border-radius:50%;background:rgba(0,0,0,.3);filter:blur(10px);z-index:-1}.reviews-luxe__stars{color:#dbbc73;letter-spacing:.22em;font-size:1rem;margin-bottom:1.15rem}.reviews-luxe__quote-mark{position:absolute;right:1.7rem;top:1rem;font-family:var(--display);font-size:4.2rem;line-height:1;color:rgba(218,185,111,.8)}.reviews-luxe__card blockquote{margin:0;font-family:var(--display);font-size:clamp(1.28rem,1.65vw,1.85rem);line-height:1.35;color:#f0e8dc;max-width:18ch}.reviews-luxe__rule{width:72px;height:1px;background:var(--gold);margin:1.8rem 0 1rem}.reviews-luxe__name{font-family:var(--mono);font-size:.82rem;letter-spacing:.18em;color:#e8e1d7}.reviews-luxe__meta{margin-top:.18rem;font-family:var(--mono);font-size:.7rem;letter-spacing:.04em;color:rgba(232,225,215,.5)}.reviews-luxe__edge{position:absolute;top:43%;width:48px;height:48px;transform:translateY(-50%);font-size:1.5rem;z-index:4}.reviews-luxe__edge:hover{transform:translateY(calc(-50% - 2px))}.reviews-luxe__edge--left{left:1.2rem}.reviews-luxe__edge--right{right:1.2rem}.reviews-luxe__footer{display:grid;grid-template-columns:1fr auto 1fr;align-items:end;margin-top:1rem}.reviews-luxe__count,.reviews-luxe__tag{font-family:var(--mono);font-size:.7rem;letter-spacing:.18em;color:rgba(201,178,127,.74);display:flex;align-items:center;gap:.9rem}.reviews-luxe__count i,.reviews-luxe__tag i{display:block;width:82px;height:1px;background:rgba(201,178,127,.6)}.reviews-luxe__tag{justify-self:end;line-height:1.35}.reviews-luxe__dots{display:flex;gap:.45rem;align-items:center}.reviews-luxe__dots button{width:8px;height:8px;border:0;padding:0;border-radius:50%;background:rgba(232,225,215,.16);cursor:pointer;transition:all .25s ease}.reviews-luxe__dots button.is-active{background:var(--gold);transform:scale(1.25)}\
@media(max-width:900px){.reviews-luxe__top{grid-template-columns:1fr}.reviews-luxe__aside{align-items:flex-start}.reviews-luxe__top h2{max-width:9ch}.reviews-luxe__track{padding:0 12vw 90px}.reviews-luxe__card{flex-basis:72vw;min-height:330px}.reviews-luxe__edge{display:none}.reviews-luxe__footer{grid-template-columns:1fr auto}.reviews-luxe__tag{display:none}.reviews-luxe__stage:before,.reviews-luxe__stage:after{left:-18vw;right:-18vw}}\
@media(max-width:620px){#reviews.reviews-luxe{padding-top:4.2rem}.reviews-luxe__top{margin-bottom:2.6rem}.reviews-luxe__top h2{font-size:clamp(2.8rem,15vw,4.8rem)}.reviews-luxe__aside>p{font-size:.95rem}.reviews-luxe__controls>span{display:none}.reviews-luxe__track{padding:0 8vw 84px;gap:16px}.reviews-luxe__card{flex-basis:84vw;min-height:310px;padding:1.8rem 1.5rem}.reviews-luxe__card.is-active{transform:scale(1)}.reviews-luxe__footer{margin-top:.8rem}.reviews-luxe__stage{min-height:460px}.reviews-luxe__stage:before{height:66px}.reviews-luxe__stage:after{height:42px}}\
